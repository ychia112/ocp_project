...
#%% print the gpu device available for tensorflow
from tensorflow.python.client import device_lib
print(device_lib.list_local_devices())
#%% data types and size adjustment
X_train = X_train[:,:,:,:,0]
X_val = X_val[:,:,:,:,0]
X_test = X_test[:,:,:,:,0]
...
with tf.device('/device:GPU:0'):
    model = Sequential([
        Conv2D(96, (11, 11), strides=(4, 4), activation='relu', padding='valid', input_shape=(214, 214, 2)),
        BatchNormalization(),
